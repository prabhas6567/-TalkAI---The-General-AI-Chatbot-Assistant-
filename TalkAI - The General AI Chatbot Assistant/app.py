...
st.markdown("""
    <style>
    .stTextInput>div>div>input {
        color: black;  /* Change text input color to black */
        background-color: #F0F2F6;
    }
    .stButton>button {
        background-color: #4F8BF9;
...
def main():
    ...
    # Conversation History Menu
        ...
        st.header("About TalkAI")
        st.write("""
        **TalkAI** is an advanced chatbot assistant designed to provide engaging and meaningful conversations. 
        Leveraging state-of-the-art Natural Language Processing (NLP) techniques, TalkAI can understand and respond to a wide range of user inputs.
        """)

        st.subheader("Project Overview")
        st.write("""
        The TalkAI project integrates two main components:
        1. **NLP Techniques**: Utilizing Logistic Regression to train the chatbot on a dataset of labeled intents, enabling it to accurately classify and respond to user queries.
        2. **Streamlit Interface**: A user-friendly web interface built with Streamlit, allowing users to interact with the chatbot seamlessly.
        """)

        st.subheader("Dataset")
        st.write("""
        The dataset used for training TalkAI includes labeled intents and entities, which help the chatbot understand and process user inputs effectively.
        - **Intents**: Categories of user input, such as greetings, inquiries, and farewells.
        - **Entities**: Specific pieces of information extracted from user input, such as dates, names, and locations.
        """)

        st.subheader("Conclusion")
        st.write("""
        TalkAI demonstrates the powerful combination of NLP and web technologies to create an interactive and engaging user experience. 
        Future enhancements may include the incorporation of more advanced NLP techniques and the expansion of the dataset to improve the chatbot's accuracy and versatility.
        """)
